...
const file_user_proto_rawDesc = "" +
	...
	"\n" +
	"UpdateUser\x12\t.upb.User\x1a\v.upb.Status\"\x00\x12(\n" +
	"\n" +
	"DeleteUser\x12\v.upb.UserId\x1a\v.upb.Status\"\x00B/Z-github.com/micros-template/proto-user/pkg/upbb\x06proto3"
...
var file_user_proto_depIdxs = []int32{
	...
	1, // 2: upb.UserService.DeleteUser:input_type -> upb.UserId
	2, // 3: upb.UserService.CreateUser:output_type -> upb.Status
	2, // 4: upb.UserService.UpdateUser:output_type -> upb.Status
	2, // 5: upb.UserService.DeleteUser:output_type -> upb.Status
